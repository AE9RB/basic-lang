...
following, you have achieved success and are ready for this short tutorial.
To exit 64K BASIC type CTRL-D.
```text
64K BASIC
READY.
█
...
Let's jump ahead a bit to saving and loading. You can `SAVE` a program
to the filesystem or `LOAD` one that you previously saved or downloaded.
Filenames are specified absolute or relative to the current directory of
your operating system when 64K BASIC was started.
